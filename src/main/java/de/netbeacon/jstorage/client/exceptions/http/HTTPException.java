...
package de.netbeacon.jstorage.client.exceptions.http;

import de.netbeacon.jstorage.client.exceptions.JStorageException;

/**
 * Blueprint for wrapping server side exceptions of the type HTTP
 */
public abstract class HTTPException extends JStorageException {
